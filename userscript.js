...
// @updateURL   https://cool-website.xyz/projects/bye-bye-pinterest/bye-bye-pinterest.js
// @downloadURL https://cool-website.xyz/projects/bye-bye-pinterest/bye-bye-pinterest.js
...
case 'www.google.com':
        ...
        {
                return 'http://' + (a.innerText.split('â€º')[0])
                        .trim();
        }, 'Gx5Zad');
        // Select the target node
        // Create a new instance of the MutationObserver with a callback function
...
case "search.yahoo.com":
        ...
        {
                return "https://" + el.innerText.split("â€º")[0]
                        .trim();
        }, 'dd');
        break;
